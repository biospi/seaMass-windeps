...
b2 stage --with-system --with-filesystem --with-log --with-program_options --stagedir=..\..\install\%SEAMASS_TOOLSET%\boost --build-dir=..\..\build\%SEAMASS_TOOLSET% %_ADDRESS_MODEL% %_TOOLSET%
if %errorlevel% neq 0 goto eof 
popd
